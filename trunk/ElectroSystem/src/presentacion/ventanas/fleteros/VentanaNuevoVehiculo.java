...
public class VentanaNuevoVehiculo extends JDialog {
	...
	public VentanaNuevoVehiculo(JDialog padre) {
		...
		lblFechaDeVencimiento.setBounds(22, 256, 141, 14);
		getContentPane().add(lblFechaDeVencimiento);

		JLabel lblEstado = new JLabel("Estado:");
		lblEstado.setBounds(21, 296, 46, 14);
		getContentPane().add(lblEstado);

		txtPatente = new JTextField();
		txtPatente.setBounds(77, 11, 226, 28);
		...
		btnCancelar.setBounds(202, 342, 101, 23);
		getContentPane().add(btnCancelar);

		btnAceptar = new JButton("Aceptar");
		btnAceptar.setBounds(91, 342, 101, 23);
		...
		springLayout.putConstraint(SpringLayout.SOUTH, vencimientoVTV.getJFormattedTextField(), 0, SpringLayout.SOUTH, vencimientoVTV);
		vencimientoVTV.setEnabled(false);
		vencimientoVTV.setBounds(172, 173, 131, 32);
		...
		springLayout2.putConstraint(SpringLayout.SOUTH, vencimientoOblea.getJFormattedTextField(), 0, SpringLayout.SOUTH, vencimientoOblea);
		vencimientoOblea.setEnabled(false);
		vencimientoOblea.setBounds(173, 244, 130, 32);
