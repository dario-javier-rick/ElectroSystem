...
public abstract class Validador {
	...
	static Pattern abcArgentino = Pattern.compile("[a-zA-Z��������������]");
	...
	public static boolean esCharDeDineroValido(String s, char c) {
		if (!esNumero(c) && c!='.')
			return false;
	...
	public static boolean DineroValido(String text) {
